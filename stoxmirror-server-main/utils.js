...
//     to: "support@Imperiumstox.com ", // list of receivers
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    from: `"Imperiumstox Team" <${process.env.EMAIL_USER}>`, // sender address
    to: to, // recipient address
    subject: "Welcome to Imperiumstox!", // subject line
    html: `
      <html>
      <head>
        <style>
      ...
      <body>
        <div class="email-container">
          <div class="header">
            <img src="cid:logo" alt="Imperiumstox Logo">
            
          </div>
          <div class="content">
            <h2>Welcome to Imperiumstox!</h2>
            <p>
              Thank you for joining Imperiumstox! We're excited to have you on board.
            ...
            <p>Best regards,</p>
            <p>The Imperiumstox Team</p>
          </div>
          <div class="footer">
            <p>
              If you did not sign up for Imperiumstox, please ignore this email or
